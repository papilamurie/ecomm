...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\ecomm\public\storage' => 'string',
            'image_sizes.product.thumbnail.width' => 'integer',
            'image_sizes.product.thumbnail.height' => 'integer',
            'image_sizes.product.small.width' => 'integer',
            'image_sizes.product.small.height' => 'integer',
            'image_sizes.product.medium.width' => 'integer',
            'image_sizes.product.medium.height' => 'integer',
            'image_sizes.product.large.width' => 'integer',
            'image_sizes.product.large.height' => 'integer',
...
'filesystems.links.C:\\laragon\\www\\ecomm\\public\\storage','image_sizes.product.thumbnail.width','image_sizes.product.thumbnail.height','image_sizes.product.small.width','image_sizes.product.small.height',
'image_sizes.product.medium.width','image_sizes.product.medium.height','image_sizes.product.large.width','image_sizes.product.large.height','logging.default',
...
'queue.failed.driver','queue.failed.database','queue.failed.table','scout.driver','scout.prefix',
'scout.queue','scout.after_commit','scout.chunk.searchable','scout.chunk.unsearchable','scout.soft_delete',
'scout.identify','scout.algolia.id','scout.algolia.secret','scout.algolia.index-settings','scout.meilisearch.host',
...
'scout.typesense.model-settings','scout.typesense.import_action','services.postmark.key','services.resend.key','services.ses.key',
...
'web','api',);
        registerArgumentsSet('routes', 'admin.login','admin.login.request','dashboard.index',
'admin.update-password','admin.verify.password','admin.update-password.request','admin.logout','admin.update-details','admin.update-details.request',
'admin.add-edit-subadmin.request','admin.add-edit-subadmin.request','categories.index',
'categories.create','categories.store','categories.show','categories.edit','categories.update',
'categories.destroy','category.image.delete','sizechart.image.delete','products.index','products.create','products.store',
'products.show','products.edit','products.update','products.destroy','product.upload.image',
'admin.products.update-image-sorting','product.upload.images','product.delete.temp.images','product.delete.temp.altimages','product.delete.temp.video',
'product.delete-image','product.upload.video','filters.index','filters.create','filters.store',
'filters.show','filters.edit','filters.update','filters.destroy','filters.updateStatus',
'filter_values.index','filter_values.create','filter_values.store','filter_values.show','filter_values.edit',
'filter_values.update','filter_values.destroy','brands.index','brands.create',
'brands.store','brands.show','brands.edit','brands.update','brands.destroy','banners.index','banners.create','banners.store',
'banners.show','banners.edit','banners.update','banners.destroy',
'coupons.index','coupons.create','coupons.store','coupons.show','coupons.edit',
'coupons.update','coupons.destroy','users.index','users.create',
'users.store','users.show','users.edit','users.update','users.destroy','currencies.index','currencies.create','currencies.store','currencies.show',
'currencies.edit','currencies.update','currencies.destroy','reviews.index',
'reviews.create','reviews.store','reviews.show','reviews.edit','reviews.update',
'reviews.destroy','search.products','cart.refresh',
'cart.index','cart.store','cart.update','cart.destroy','cart.apply.coupon',
'cart.remove.coupon','currency.switch','user.login','user.login.post','user.register',
'user.register.post','user.password.forgot','user.password.forgot.post','user.password.reset','user.password.reset.post',
'user.logout','password.reset','product.review.store','storage.local',);
        registerArgumentsSet('views', 
'admin.banners.add_edit_banner','admin.banners.index','admin.brands.add_edit_brand','admin.brands.index','admin.categories.add_edit_category',
'admin.categories.index','admin.coupons.add_edit_coupon','admin.coupons.index','admin.currencies.add_edit_currency','admin.currencies.index',
'admin.dashboard','admin.filter_values.add_edit_filter_value','admin.filter_values.index','admin.filters.add_edit_filter','admin.filters.index',
'admin.layout.footer','admin.layout.header','admin.layout.layout','admin.layout.scripts','admin.layout.sidebar',
'admin.layout.styles','admin.login','admin.products.add_edit_product','admin.products.index','admin.reviews.index',
'admin.subadmins.add_edit_subadmin','admin.subadmins.subadmins','admin.subadmins.update_roles','admin.update-details','admin.update-password',
'admin.users.index','emails.user_registered','front.auth.forgot_password','front.auth.login','front.auth.register',
'front.auth.reset_password','front.cart.ajax_cart_items','front.cart.ajax_cart_summary','front.cart.index','front.index',
'front.layout.footer','front.layout.header','front.layout.layout','front.layout.scripts','front.layout.styles',
'front.products.ajax_products_listing','front.products.detail','front.products.filters','front.products.index','laravel-exceptions-renderer::components.badge',
...
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.laragon.www.ecomm.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SCOUT_DRIVER','ALGOLIA_APP_ID',
'ALGOLIA_SECRET',);
